...
function selectionSettings() {
  ...
  (() => {
    ...
    // Color Picker 예외적으로 Jquery 문법 유지
    const colorPicker = $(
    ...
    selectPanelContent.insertAdjacentHTML(
      ...
      `
        <div class="effect-section">
          ...
          <h5>감마</h5>
          <div class="input-container"><label>빨간색</label><input class="effect" id="gamma.r" type="range" min="0" max="100" value="50"></div>
          <div class="input-container"><label>초록색</label><input class="effect" id="gamma.g" type="range" min="0" max="100" value="50"></div>
          <div class="input-container"><label>파랑색</label><input class="effect" id="gamma.b" type="range" min="0" max="100" value="50"></div>
          <hr>
        </div>
      `
    );
