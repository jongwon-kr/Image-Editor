import { save, remove } from "../utils/saveInBrowser.js";
import { downloadImage, downloadSVG } from "../utils/utils.js";
/**
 * 상,하단 툴바
 */
    ...
    container.insertAdjacentHTML(
      ...
      `
            <div class="toolbar" id="toolbar">
                ...
                <div class="title">Graphic Cast Editor</div>
      ...
      button.addEventListener("click", function () {
        ...
        if (id === "save") {
          if (window.confirm("현재 캔버스를 저장하시겠습니까?.")) {
            save("canvasEditor", _self.canvas.toJSON());
          }
        } else if (id === "clear") {
          if (window.confirm("현재 캔버스를 지우시겠습니까?")) {
            _self.canvas.clear();
            remove("canvasEditor");
          }
        } else if (id === "download") {
